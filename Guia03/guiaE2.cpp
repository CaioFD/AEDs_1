...
public:
    ...
    */
    ...
    int pickBeepers()
    {
        ...
        x = xAvenue();
        y = yStreet();
        char fileName[15] = "Tarefa03E2.txt";
    ...
    */
    void doTask(const char *fileName)
    {
        ...
        quantidade = readCommands(comandos, "Tarefa03E2.txt");
...
int main()
{
    ...
    world->read("Guia03E2.txt"); // ler configuracao atual para o ambiente
    ...
    robot1->create(2, 6, EAST, 0, "Karel");
    robot2->create(8, 5, EAST, 0, "Jarel");
