...
public:
    ...
    */
    ...
    int pickBeepers()
    {
        ...
        x = xAvenue();
        y = yStreet();
        char fileName[15] = "Tarefa03E1.txt";
    ...
    */
    void doTask(const char *fileName)
    {
        ...
        quantidade = readCommands(comandos, "Tarefa03E1.txt");
...
int main()
{
    ...
    robot1->create(8, 6, EAST, 0, "Karel");
    robot2->create(2, 5, EAST, 0, "Jarel");
    ...
    // executar tarefa
    robot2->doTask("Tarefa03E1_1.txt");
    robot1->doTask("Tarefa03E1_2.txt");
    robot2->doTask("Tarefa03E1_3.txt");
    robot1->doTask("Tarefa03E1_4.txt");
    robot2->doTask("Tarefa03E1_5.txt");
